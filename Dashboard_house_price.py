...
Rental Estimates,saleEstimate_currentPrice,saleEstimate_confidenceLevel,saleEstimate_valueChange, transaction History providing insight into property appreciation or depreciation')

...
st.text('Key variables include fullAddress: Complete property address, postcode: Postal code identifying specific areas, outcode: First part of the postcode, grouping properties into broader geographic zones, latitude & longitude: Geographic coordinates for mapping or location-based analysis, property details: Includes bathrooms, bedrooms, floorAreaSqM, livingRooms, tenure (e.g., leasehold or freehold), and propertyType (e.g., flat, maisonette), energy rating: Current energy rating, indicating the property’s energy efficiency.Pricing Information includes
        Rental Estimates: Ranges for estimated rental values (rentEstimate_lowerPrice, rentEstimate_currentPrice, rentEstimate_upperPrice),Sale Estimates: Current sale price estimates with confidence levels and historical changes,saleEstimate_currentPrice: Current estimated sale price,
        saleEstimate_confidenceLevel: Confidence in the sale price estimate (LOW, MEDIUM, HIGH),saleEstimate_valueChange: Numeric and percentage change in sale value over time,

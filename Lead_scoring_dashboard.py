...
st.header(':blue[In this project I implemented a model that can determine if a lead will be converted or not, using key variables, this model will save resources and time for American business, imagine a situation where a team can use least time to achieve higher revenue]')

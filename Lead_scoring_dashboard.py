...
False Positive (FP) = 70: These are the cases where the model incorrectly predicted the positive class (e.g., "conversion" when the actual outcome was "no conversion").

...
st.title(':blue[This project is trying to implement a model that can determine if a lead will be converted or not, using key variables, this model will save resources and time of our sales team, using least time to achieve higher revenue]')

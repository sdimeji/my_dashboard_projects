...
clf = RandomForestRegressor(n_estimators=250, max_depth=7, max_features=1.0, criterion='squared_error')
...
reg2_plot=px.scatter(x=x_pred,y=y_test,trendline='ols',title='Stockastic Gradient Descent regression prediction vs actual value',height=800)
reg2_plot.show()